...
//	[self.delegate hostGameLayerDidCancel:self];
//}
//
...
//	[self.delegate hostGameLayer:self didEndSessionWithReason:_quitReason];
//}
//
...
//		[self.delegate hostGameLayer:self startGameWithSession:_matchMakingServer.session clients:_matchMakingServer.connectedClients];
//	}
//}
//@end
