...
//}
//
//@synthesize availableServers, session, delegate;
//
//- (id)init
//{
//	if ((self = [super init]))
...
//        availableServers = [[NSMutableArray arrayWithCapacity:10] retain];
//        
//        session = [[GKSession alloc] initWithSessionID:sessionID displayName:nil sessionMode:GKSessionModeClient];
...
//                if (clientState == ClientStateConnecting && [peerID isEqualToString:_serverPeerID])
//                {
...
//	[session connectToPeer:peerID withTimeout:session.disconnectTimeout];
//}
//
//-(void)dealloc{
//    availableServers = nil;
